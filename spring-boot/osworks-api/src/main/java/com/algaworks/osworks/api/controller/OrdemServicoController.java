...
public class OrdemServicoController {
	...
	@GetMapping
	public List<OrdemServicoModel> listarOrdemDeServico(){
		return toCollectionModel(ordemServicoRepository.findAll());
	}
	
	@GetMapping("/{OSId}")
	public ResponseEntity<OrdemServicoModel> searchById(@PathVariable long OSId){
	...
	public List<OrdemServicoModel> toCollectionModel(List<OrdemServico> ordensServico){
